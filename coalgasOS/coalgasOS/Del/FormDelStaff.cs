...
namespace coalgasOS
{
    public partial class FormDelStaff : FormClass
    {
        ...
        private void initMyDataGridView()
        {
            ...
            dataAdapter.Fill(myDataSet, "staff");

            //使用DataSet绑定时，必须同时指明DateMember 
            this.dataGridView.DataSource = myDataSet;
            this.dataGridView.DataMember = "staff";
        ...
        private void FormDelStaff_Load(object sender, EventArgs e)
        {
            initMyDataGridView();
        }

        private void buttonDelStaffDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView.SelectedRows)
                {
                    ...
                    //删除
                    string sql = "delete from staff where staff_id = '" + row.Cells[0].Value.ToString() + "';";
        ...
        private void dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                //修改
                string sql = "update staff set staff_name='" + name + "',staff_phone='" + phone + "',staff_add='" + add + "',staff_note='" + note + "' where staff_id='" + id + "';";
                SqlCommand command = new SqlCommand(sql, connection);
                int isok = command.ExecuteNonQuery();
