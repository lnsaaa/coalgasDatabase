...
namespace coalgasOS
{
    public partial class FormDelClient : FormClass
    {


        public FormDelClient()
        {
            InitializeComponent();
        }
        ...
        private void initMyDataGridView()
        {
            ...
            dataAdapter.Fill(myDataSet, "client");

            //使用DataSet绑定时，必须同时指明DateMember 
            this.dataGridView.DataSource = myDataSet;
            this.dataGridView.DataMember = "client";
        ...
        private void FormDelClient_Load(object sender, EventArgs e)
        {
            initMyDataGridView();
        }

        private void buttonDelClientDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView.SelectedRows)
                {
                    ...
                    // 删除
                    string sql = "delete from client where client_id = '" + row.Cells[0].Value.ToString() + "';";
        ...
        private void dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                //修改
                string sql = "update client set client_name='" + name + "',client_phone='" + phone + "',client_add='" + add + "',client_note='" + note + "' where client_id='" + id + "';";
                SqlCommand command = new SqlCommand(sql, connection);
